...
// 環境変数 GAYATALK_E2E_SERVER が無ければスキップする:
//
//	cd server && npx wrangler dev --port 8787   # 別端末で
//	GAYATALK_E2E_SERVER=http://localhost:8787 go test ./internal/room -run E2E -v
...
// 実行方法は TestE2ERelay と同じ(GAYATALK_E2E_SERVER が無ければスキップ)。
